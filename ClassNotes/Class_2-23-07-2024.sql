...
create or replace table employee (empid   number,
                       name    varchar(20),
                       address varchar(30)
                       )  ;
use hr.vitech;
...
// entire table data is going to delete 
...
select count(*) from HR.VITECH.COUNTRIES;// count no 25
...
select employee_id ,
      ...
      salary ,
      email
      from employees  where employee_id in (202,201,203,204);
